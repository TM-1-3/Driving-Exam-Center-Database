...
- [Database Creation and Population](#4)
  - [SQL Creation Script](#4.1)
  - [SQL Population Script](#4.2)
...
The SQL script **create.sql** for creating the database is available [here](https://github.com/TM-1-3/Driving-Exam-Center-Database/blob/master/create.sql).
...
The SQL script **populate.sql** for populating the database is available [here](https://github.com/TM-1-3/Driving-Exam-Center-Database/blob/master/populate.sql).
